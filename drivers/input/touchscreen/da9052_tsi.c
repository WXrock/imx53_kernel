 ...
 * (delta_x[0], delta_x[1], delta_x[2], delta_y[0],
 *  delta_y[1], delta_y[2], delta).
 * Which is generated by the calibration service.
 * In this driver when we get a touch pointer (x', y') from the PMIC ADC,
						...
						u8 state)
{
	...
	s32 ret = 0;
	struct da9052_tsi_info *ts = get_tsi_drvdata();
	da9052_tsi_set_calib_matrix(calibration);
