...
#if Xrock_DEBUG
#define wx_dbg(fmt, arg...) printk("\t<Xrock> ov3640.c %s:"fmt"\n",__func__,##arg)
#else
...
{0x3011, 0x00, 0, 0}, {0x3012, 0x00, 0, 0}, {0x3020, 0x01, 0, 0},
...
{0x3363, 0x08,0,0},
{0x3364, 0x04,0,0},
{0x3403, 0x42,0,0},//XY start
{0x3088, 0x08,0,0},//X size
{0x3089, 0x00,0,0},//X size
{0x308a, 0x06,0,0},//Y size
{0x308b, 0x00,0,0},//Y size
};
...
{0x3363, 0x88},
{0x3364, 0xe4},
{0x3403, 0x42},//XY start
{0x3088, 0x02},//X size
{0x3089, 0x80},//X size
{0x308a, 0x01},//Y size
{0x308b, 0xe0},//Y size
{0x3100, 0x02}, //format,yuv
{0x3301, 0xde},//wbc
{0x3304, 0x00},
{0x3400, 0x00},//yuv
{0x3404, 0x42},//uyvy
{0x3600, 0xc4}, //vsync polarity
{0x308d, 0x04},
{0x3086, 0x03},
{0x3086, 0x00},
};
...
void ov3640_init_config(void) {
    ...
    for(i=0;i<OV3640_INIT_REGS;i++) {
        ov3640_write_reg(ov3640_reg[i].subaddr,ov3640_reg[i].value);
    }
}
