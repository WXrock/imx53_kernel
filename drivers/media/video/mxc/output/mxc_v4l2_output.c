		     ...
		     unsigned int ioctlnr, void *arg)
{
	...
	case VIDIOC_G_FMT:
		{
            pr_debug("mxc_v4l2_output:VIDIOC_G_FMT\n");
	...
	case VIDIOC_S_FMT:
		{
            pr_debug("mxc_v4l2_output:VIDIOC_S_FMT\n");
	...
	case VIDIOC_STREAMON:
		{
            pr_debug("mxc_v4l2_output:VIDIOC_STREAMON\n");
	...
	case VIDIOC_S_CTRL:
		{
            pr_debug("mxc_v4l2_output:VIDIOC_S_CTRL");
	...
	case VIDIOC_S_OUTPUT:
		{
            pr_debug("mxc_v4l2_output:VIDIOC_S_OUTPUT\n");
			int *p_output_num = arg;
			int fbnum;
			struct v4l2_rect *b;
