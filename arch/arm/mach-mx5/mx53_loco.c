...
#define USER_KEY1			(3*32 + 1)	/* GPIO_4_1 */  // mxl add 20130520 : key1
#define USER_KEY2			(3*32 + 4)	/* GPIO_4_4 */ // mxl add 20130520 : key2
#define USER_KEY3			(3*32 + 13)	/* GPIO_4_13 */ // mxl add 20130520 : key3
#define USER_KEY4			(1*32 + 14)	/* GPIO_2_14 */ // mxl 20130520 : key4 
#define USER_KEY5			(3*32 + 3)	/* GPIO_4_3 */ 
...
//////////add by MXR//////////////////////////REMOVED BY Xrock//////
//#define MX53_CAN1_EN1			(3*32 + 10)	/* GPIO_4_10 */
//#define MX53_CAN1_EN2			(3*32 + 11)	/* GPIO_4_11 */
#define MX53_LED1                       (2*32 + 26)	/* GPIO_3_26 */
#define MX53_LED2                       (2*32 + 27)	/* GPIO_3_27 */
#define MX53_LED3                       (2*32 + 16)	/* GPIO_3_16 */
//#define MX53_CSPI_SS0                   (2*32 + 29)     /* GPIO_3_29*/
//#define MX53_INPUT1                     (1*32 + 12)     /* GPIO_2_12*/
//#define MX53_INPUT2                     (1*32 + 13)     /* GPIO_2_13*/
//#define MX53_INPUT3                     (1*32 + 7)     /* GPIO_2_7*/
//#define MX53_INPUT4                     (6*32 + 8)     /* GPIO_7_8*/
//#define MX53_W1                         (2*32 + 18)     /* GPIO_3_18*/
//#define MX53_W2                         (2*32 + 17)     /* GPIO_3_17*/
//#define MX53_OUTPUT1                    (4*32 + 4)     /* GPIO_5_4*/
//#define MX53_OUTPUT2                    (5*32 + 6)     /* GPIO_6_6*/
//#define MX53_OUTPUT3                    (1*32 + 21)     /* GPIO_2_21*/
//#define MX53_OUTPUT4                    (2*32 + 4)     /* GPIO_3_4*/
//#define USER_KEY1			(3*32 + 2)	/* GPIO_4_2 */  // mxl add 20130520 : key1
//#define USER_KEY2			(3*32 + 0)	/* GPIO_4_0 */ // mxl add 20130520 : key2
//#define USER_KEY3			(3*32 + 1)	/* GPIO_4_1 */ // mxl add 20130520 : key3
//#define USER_KEY4			(3*32 + 4)	/* GPIO_4_4 */ // mxl 20130520 : key4 
//#define MX53_SD3_SD2			(2*32 + 13)	/* GPIO_3_13 */
//////////add by MXR////////////////////////////////
...
static iomux_v3_cfg_t mx53_loco_pads[] = {
	...
	MX53_PAD_GPIO_6__I2C3_SDA,
        /* CSPI  Xrock removed*/
	//MX53_PAD_EIM_D29__CSPI_SS0,
    //MX53_PAD_EIM_D29__GPIO3_29,
	//MX53_PAD_EIM_D21__I2C1_SCL,
	//MX53_PAD_EIM_D22__CSPI_MISO,
	...
	//key Xrock removed
//        MX53_PAD_GPIO_12__GPIO4_2,         //key1
//        MX53_PAD_GPIO_10__GPIO4_0,         //key2
//        MX53_PAD_GPIO_11__GPIO4_1,         //key3
//    	MX53_PAD_GPIO_14__GPIO4_4,         //key4  
         //led 
          MX53_PAD_EIM_D26__GPIO3_26,        //LED1
          MX53_PAD_EIM_D27__GPIO3_27,        //LED2
          MX53_PAD_EIM_D16__GPIO3_16,        //LED3
        //Input
...
//        MX53_PAD_EIM_D18__GPIO3_18,       //w1
//        MX53_PAD_EIM_D17__GPIO3_17,       //w2
        //OutPut 
//        MX53_PAD_EIM_A24__GPIO5_4, 
//        MX53_PAD_EIM_A23__GPIO6_6, 
//        MX53_PAD_EIM_A17__GPIO2_21, 
//        MX53_PAD_EIM_DA4__GPIO3_4, 
        //SD2 SD3 change by MXR
//        MX53_PAD_EIM_DA13__GPIO3_13, 
        /*MX53_PAD_GPIO_11__GPIO4_1,         //add by MXR 20130807:key1
	MX53_PAD_GPIO_14__GPIO4_4,         //add by MXR 20130807:key2
	MX53_PAD_PATA_DATA13__GPIO2_13, // mxl 20130520 add :key3
	MX53_PAD_PATA_DATA14__GPIO2_14, // mxl 20130520 :key4
	MX53_PAD_GPIO_13__GPIO4_3,         //add by MXR 20130807:key5
        MX53_PAD_GPIO_10__GPIO4_0,*/              //add by MXR 20130807:key6
...
static struct fb_videomode video_modes[] = {
	...
	{ // mxl add 20130521 for ek070n93.
	 ...
	 FB_VMODE_NONINTERLACED,
	 0,},
         { // moxiaoran add 20130803 for wxcat35.
	 "WXCAT35", 60, 320, 240, 156250,
	 38,20,
	 15,12,
	 30,3,
	 FB_SYNC_CLK_LAT_FALL, 
...
static struct mxc_fb_platform_data fb_data[] = {
	{
	 ...
	 //.mode_str = "EK070TN93",   // mxl 20130521 for ek070n93
          .mode_str = "WXCAT35",      // moxiaoran 20130803 for wxcat35
	 .mode = video_modes,
...
// add by MXR 20130805 removed by Xrock
//static struct mxc_tvin_platform_data  tvin_data = {
	//.mclk = 24000000,
	//.csi = 0,
//};
...
// add by MXR removed by Xrock
//static struct spi_board_info pca2129_device[] __initdata = {
//{
...
static struct i2c_board_info mxc_i2c2_board_info[] __initdata = {
	...
	{ // Xrock add
	.type = "ov3640",
	.addr = 0x3c,//0x30 for ov9650  0x3c for ov3640
	.platform_data = (void *)&camera_data,
	 },
   //     { // add by MXR 20130805
//	.type = "tw2836",
...
static int sdhc_write_protect(struct device *dev)
{
	...
	if (to_platform_device(dev)->id == 2)
        ...
        printk("SD3_WP value is : %d\n",ret);
        //add by MXR 20130805
        //if (to_platform_device(dev)->id == 1)
		//ret = gpio_get_value(SD2_WP);
        //add by MXR 20130805
	return ret;
}
...
static struct mxc_mmc_platform_data mmc3_data = {
	.ocr_mask = MMC_VDD_27_28 | MMC_VDD_28_29 | MMC_VDD_29_30
		| MMC_VDD_30_31 | MMC_VDD_31_32 | MMC_VDD_32_33 | MMC_VDD_33_34,   //Xrock modify 20141117
...
{	
    ...
    //gpio_request(USB_EN,"usb-en");
    //gpio_set_value(USB_EN , 1 ); //20140831
        /////////////add by MXR////////////////
	// txmcu add 20130522
	/* Camera power down */
	...
	msleep(20);
	gpio_set_value(MX53_LOCO_CSI0_RST, 1);//Xrock
	// txmcu
	...
	gpio_direction_output(DISP0_POWER_EN, 1);
        ...
        //Led IO test by MXR  removed by Xrock
        gpio_request(MX53_LED1, "led1");
	gpio_direction_output(MX53_LED1, 0);
        gpio_request(MX53_LED2, "led2");
	gpio_direction_output(MX53_LED2, 0);
        gpio_request(MX53_LED3, "led3");
	gpio_direction_output(MX53_LED3, 0);
        //output IO by MXR
//        gpio_request(MX53_OUTPUT1, "output1");
//	gpio_direction_output(MX53_OUTPUT1, 1);
//        gpio_request(MX53_OUTPUT2, "output2");
//	gpio_direction_output(MX53_OUTPUT2, 1);
//        gpio_request(MX53_OUTPUT3, "output3");
//	gpio_direction_output(MX53_OUTPUT3, 1);
//        gpio_request(MX53_OUTPUT4, "output4");
//	gpio_direction_output(MX53_OUTPUT4, 1);
        //input IO By MXR
//        gpio_request(MX53_INPUT1, "input1");
//	gpio_direction_input(MX53_INPUT1);
//        gpio_request(MX53_INPUT2, "input2");
//	gpio_direction_input(MX53_INPUT2);
//        gpio_request(MX53_INPUT3, "input3");
//	gpio_direction_input(MX53_INPUT3);
//        gpio_request(MX53_INPUT4, "input4");
//	gpio_direction_input(MX53_INPUT4);
        //w1,w2 by mxr
//        gpio_request(MX53_W1, "w1");
//	gpio_direction_input(MX53_W1);
//        gpio_request(MX53_W2, "w2");
//	gpio_direction_input(MX53_W2);
        //key IO By MXR
//        gpio_request(USER_KEY1, "key1");
//	gpio_direction_input(USER_KEY1);
//        gpio_request(USER_KEY2, "key2");
//	gpio_direction_input(USER_KEY2);
//        gpio_request(USER_KEY3, "key3");
//	gpio_direction_input(USER_KEY3);
//        gpio_request(USER_KEY4, "key4");
//	gpio_direction_input(USER_KEY4);
        //SD3,SD2 change by MXR
//        gpio_request(MX53_SD3_SD2, "sd3_sd2");
//	gpio_direction_output(MX53_SD3_SD2, 0);
        //CSPI SS0 by MXR
//        gpio_request(MX53_CSPI_SS0, "ss0");
//	gpio_direction_output(MX53_CSPI_SS0, 0);
}
...
//Xrock removed 
// spi_register_board_info(pca2129_device,
//				ARRAY_SIZE(pca2129_device));
