...
static int _clk_enable(struct clk *clk)
{
	...
	if (clk->flags & AHB_HIGH_SET_POINT)
        ...
        //printk(KERN_ERR "MXC_CCM_CCGR6=%x\n",reg);
        //reg = __raw_readl(MXC_CCM_CCGR4); 
        //printk(KERN_ERR "MXC_CCM_CCGR4=%x\n",reg);
	return 0;
}
...
static int _can_root_clk_set(struct clk *clk, struct clk *parent)
{
	...
	__raw_writel(reg, MXC_CCM_CSCMR2);
        //printk(KERN_ERR "MXC_CCM_CSCMR2:%x\n",reg); 
...
int __init mx53_clocks_init(unsigned long ckil, unsigned long osc, unsigned long ckih1, unsigned long ckih2)
{
	...
	__raw_writel(reg, MXC_CCM_CDCDR);
        ...
        clk_set_parent(&can1_clk[0],&lp_apm_clk);  ////////add/////////
        clk_set_parent(&can2_clk[0],&lp_apm_clk);  ////////add//////
	...
	lp_high_freq = 0;
        ...
        //reg = __raw_readl(MXC_CCM_CCGR6); 
        //printk(KERN_ERR "MXC_CCM_CCGR6_init=%x\n",reg);
        //reg = __raw_readl(MXC_CCM_CCGR4); 
        //printk(KERN_ERR "MXC_CCM_CCGR4_init=%x\n",reg);
	return 0;
}
